---
layout: post
title: "How to Organize Your Digital Life in One Weekend"
...
<div style="background: #eef4ff; border: 2px solid #2563eb; border-radius: 12px; padding: 25px; margin: 30px 0; text-align: center;">
  <h3 style="color: #1e3a5f; margin-top: 0;">Get the Digital Life Organizer</h3>
  <p style="color: #555; margin-bottom: 15px;">Track subscriptions, manage devices, and keep your digital life organized with this Notion template.</p>
  <a href="https://smarttemplatesell.gumroad.com/l/digital-organizer" target="_blank" style="display: inline-block; background: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold;">Get It Now - $6.99</a>
</div>
