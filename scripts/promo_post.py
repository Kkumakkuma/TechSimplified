"""
TechSimplified - Gumroad Promotional Post Generator v2
...
PROMO_PRODUCTS = [
    {
        ...
        "price": "$6.99",
        "slug": "digital-organizer",
        "desc": "Organize your digital life with our all-in-one Notion dashboard.",
        "keywords": ["digital organization", "productivity", "password management", "digital declutter"],
    },
    {
        "name": "Tech Purchase Decision Maker",
        "price": "$5.99",
        "slug": "tech-decision",
        "desc": "Make smarter tech purchases with our comparison template.",
        "keywords": ["tech buying guide", "gadget comparison", "smart purchase", "tech review"],
    },
]

PROMO_SYSTEM_PROMPT = """You are an expert technology writer.
