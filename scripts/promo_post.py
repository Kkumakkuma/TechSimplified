"""
TechSimplified - Gumroad Promotional Post Generator
...
PROMO_PRODUCTS = [
    {"name": "Digital Life Organizer", "price": "$6.99", "slug": "digital-organizer", "desc": "Organize your entire digital life in one place."},
    {"name": "Tech Purchase Decision Maker", "price": "$5.99", "slug": "tech-decisions", "desc": "Make smarter tech purchases with side-by-side comparisons."},
]
